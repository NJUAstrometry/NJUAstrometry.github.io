...
**银河系光行差（Galactic Aberration, GA）** 是由太阳系质心绕银河系中心运动的向心加速度所引起的视运动效应。其视运动幅度约为 5 μas/yr，会造成天球参考架的缓慢自旋和区域性畸变，并对 **地球定向参数（EOP）** 的岁差速率产生约 1 μas/yr 的影响。在 ICRF3 与 Gaia 参考架连接的高精度天体测量时代，必须对 GA 效应进行显式建模，以保持参考架的刚性与非旋转特性。本文给出了基于矢量球谐函数（VSH）的偶极场描述，并推导了光行差引起的视运动与参考架旋转之间的定量关系。
