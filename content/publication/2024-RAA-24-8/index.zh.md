...
publication: "*《天文学研究与天体物理学》(Research in Astronomy and Astrophysics)* 24:085011 (2024)"
publication_short: "*RAA* 24:085011 (2024)"

abstract: >
  本文利用模拟的河外源观测数据，评估 CSST 巡天拓展 Gaia 天球参考架的潜力。
  研究考察了随机观测误差引起的参考架定向不确定度、有限天区覆盖的影响，
  以及向暗端和不同波段拓展参考架的可行性。

summary: "通过模拟观测，评估 CSST 巡天拓展 Gaia 天球参考架的精度与潜力。"

tags: ["天体测量学", "参考系", "巡天", "CSST", "Gaia"]
