...
publication: "*Research in Astronomy and Astrophysics* 24:085011 (2024)"
publication_short: "*RAA* 24:085011 (2024)"

abstract: >
  Using simulated extragalactic source observations, we assess the potential
  of the CSST sky survey to extend the Gaia celestial reference frame.
  We examine orientation uncertainty from random measurement errors,
  the effects of limited sky coverage, and the prospects for extending
  reference frames to fainter sources and additional wavelength bands.

summary: "A simulation-based assessment of the CSST sky survey's potential to extend the Gaia celestial reference frame."
...
image:
  caption: "China Space Station Telescope (Yao et al. 2024, *RAA* 24:085011)"
  focal_point: "center"
  preview_only: false
...
Finally, this work explored the potential role of CSST-CRF in establishing a multi-band reference frame. Establishing a multi-band reference frame is an important goal of astrometry. We plotted on the figure the main range of observed magnitudes of CSST and several common near-ultraviolet (NUV) / near-infrared (NIR) band star catalogs, as well as the observation precision at different magnitudes. From the figure, it can be seen that the addition of CSST can supplement the missing faint end observations in the current NUV and NIR bands. Since the faint end has a higher source density, it can be expected that the observations of CSST can greatly increase the number of sources in the NIR and NUV reference frames and expand the magnitude range of the reference frames.
...
- <span id="Gaia_CRF3"></span>[1] Gaia Collaboration, Klioner, S. A., Lindegren, L., et al. "Gaia Early Data Release 3. The celestial reference frame (Gaia-CRF3)." Astronomy & Astrophysics, vol. 667, 2022, p. A148. doi:10.1051/0004-6361/202243483
- <span id="Mignard2012"></span>[2] Mignard, F., and Klioner, S. "Analysis of Astrometric Catalogues with Vector Spherical Harmonics." Astronomy & Astrophysics, vol. 547, 2012, p. A59. doi:10.1051/0004-6361/201219927.
